...
- Los endpoints `/api/recipes` usan sesiones Supabase (`createRouteHandlerClient`) y RLS. Se valida payload con Zod y se limita a 50 recetas por consulta.
...
- Extender las políticas Supabase (favoritos, enlaces compartidos) y añadir controles de autorización adicionales.
